...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("hsv_low_h", default_value="35"),
            DeclareLaunchArgument("hsv_low_s", default_value="80"),
            DeclareLaunchArgument("hsv_low_v", default_value="80"),
            DeclareLaunchArgument("hsv_high_h", default_value="85"),
